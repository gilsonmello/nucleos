...
<div class="row" style="margin-top: 20px;">
<?php echo $this->Form->input('permission', array('label'=>'Permissões', 'multiple' => 'true', 'type' => 'select', 'options'=>$optionsPermissions, 'selected' => $selectedPermissions, 'class'=>'chosen-select','div'=>array('class'=>'col-xs-12')));?>
</div>
